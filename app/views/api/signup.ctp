<div class="grid_12">
	...
	<p>There are no real restrictions on the use of the API, however we would appreciate some forewarning if you intend heavy usage.</p>
</div>
<div class="clear"></div>
<div class="grid_12"><?php echo $this->Session->flash(); ?></div>
<div class="clear"></div>
